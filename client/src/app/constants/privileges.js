...
export const READ_WRITE = [PERMISSIONS.READ, PERMISSIONS.CREATE, PERMISSIONS.UPDATE];
export const BASIC_OPERATIONS = [...READ_WRITE, PERMISSIONS.DELETE, PERMISSIONS.RESTORE];

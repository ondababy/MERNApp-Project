...
export default function ProductDisplay({ children }) {
    return (
        <div className='w-screen min-h-screen h-screen flex lg:flex-row items-start'>
            ...
            <div className='p-8 container max-w-sm h-screen border border-base-content/10 bg-base-100'>
                ...
                <p className='font-light my-2'>
                    Dolor praesentium in sed rerum nostrum. Laborum in aliquid illum, quidem cumque excepturi. Iure ea in, dolore fugiat repudiandae quod soluta corporis!
                </p>
